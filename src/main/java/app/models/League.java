...
public class League implements DefaultInterface {
    ...
    League(String leagueID, String leagueName, boolean privateMode) {
    ...
    League(String leagueID, String leagueName, User owner, boolean privateMode) {
        this.leagueID = leagueID;
        this.leagueName = leagueName;
        this.totalValue = 0.0;
        this.userList = new ArrayList<User>();
    ...
    League(String leagueID, String leagueName, double leagueValue, boolean privateMode,
